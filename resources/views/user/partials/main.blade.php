...
<div class="content">
		<div class="container-fluid">
			<div class="row justify-content-center">
				<!-- Daftar Resep -->
				<div class="col-lg-9">
                <h3 style="margin-top:15px;">Resep Terbaru</h3>
                                    ...
                                    <div class="product-wrapper mb-30">
                                        <div class="product-img text-center"style="margin: auto;">
                                            <a href="{{ url('home/'. $recipe->slug) }}">
                                                    <img src="{{ asset('storage/foto_resep/'.$recipe->foto) }}" alt="{{ $recipe->judul }}" style="height:200px;width:280px;margin: auto;">
                                            </a>
                                        </div>
                                        <br>
                                        <div class="product-content text-left">
                                            <h4><a href="{{ url('home/'. $recipe->slug) }}" class="text-dark">{{ $recipe->judul }}</a></h4>
